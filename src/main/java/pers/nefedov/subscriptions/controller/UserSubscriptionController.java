...
public class UserSubscriptionController {
    ...
    public ResponseEntity<UserSubscriptionDto> addSubscription(@PathVariable @Positive @Schema(description = "ID пользователя", example = "1") Long userId, @RequestBody AddSubscriptionRequest request) {

        UserSubscriptionDto dto = userSubscriptionService.addSubscriptionToUser(userId, request.subscriptionId());
    ...
    public ResponseEntity<List<UserSubscriptionDto>> getSubscriptions(@PathVariable @Positive @Schema(description = "ID пользователя", example = "1") Long userId) {
    ...
    public void deleteSubscription(@PathVariable @Positive @Schema(description = "ID пользователя", example = "1") Long userId, @PathVariable @Positive @Schema(description = "ID подписки", example = "1") Long subId) {
